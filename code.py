...
def instances_based_condition(df,col1,val1,col2,val2):
    ...
    """
    type1=df[(df[col1]>val1)]
    type2=type1[(type1[col2]==val2)]
    return type2
...
def agg_values_ina_month(df,date_col,agg_col, agg):
    ...
    aggregated_value=pivot=df.pivot_table(index="month",values=agg_col,aggfunc=agg)
